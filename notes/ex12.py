...
def fitData(fileName):
    ...
    pylab.xlabel('|Force| (Newtons)')
    pylab.ylabel('Distance (meters)')
    a,b = pylab.polyfit(xVals, yVals, 1) #polyfit == MMQ => (x, y, degree) => y = ax + b (linear regression)
...
def fitData1(fileName):
    ...
    a,b,c,d = pylab.polyfit(xVals, yVals, 3) #cubic fit
...
# R^2 = 1 - EE/MV
# EE = estimated error and MV = measured variance
