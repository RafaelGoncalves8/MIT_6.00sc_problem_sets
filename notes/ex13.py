...
#  - Minkowski Metric: dist(x1, x2, p) = (SUM(abs(X1-X2)^p)^1/p
...
# 2) choose k points as initial centroid
#       often choose at random
# 3) Assign each point with a cluster
