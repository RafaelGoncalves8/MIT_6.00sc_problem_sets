### Graph Theoretic and Dynamic Programming
## Graph: set of nodes(vertices) connected by a set of edges(arcs)
## Digraph = Unidirectional edges
...
## Dynamic Programming
## Memoryzation: table lookout (store solutions that you will solve again)
## Can be used in problems with:
## optimal substructure and
## global solution can be found by combining locally optimal sol.
